...
export function Aside() {
  return (
    <aside className="bg-gray-400 fixed bottom-0 left-[5%] w-11/12 mx-auto flex  h-20 max-h-24 pb-4 sm:w-max sm:left-0  sm:h-max sm:max-h-none  sm:sticky sm:top-5">
